...
class TestClass3 implements Runnable {
    public void run() {
        Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
        capsHashtable.put("browser", "chrome");
        capsHashtable.put("browser_version", "77.0");
...
public class mainTestClass {
    public static final String USERNAME = "harshakapila_mOf2hW";
    public static final String AUTOMATE_KEY = "YEgWf59GXjkPVaNx3REy";
